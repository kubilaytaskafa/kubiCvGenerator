...
import {
  ...
  FaListAlt,
  FaLightbulb,
} from "react-icons/fa"; // Yeni ikonlar eklendi
  ...
  return (
    <div className="home-container">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <div className="d-flex gap-3 justify-content-center">
                <Link to="/cv" className="btn btn-primary btn-lg px-4">
                  Hemen CV Oluştur
                </Link>
                <Link to="/cv-ats" className="btn btn-outline-dark btn-lg px-4">
                  ATS Dostu Mod
                </Link>
              </div>
            </div>
        ...
        <div className="row g-4">
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm text-center p-4">
              ...
              <h4 className="card-title fw-bold">Kolay Kullanım</h4>
          ...
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm text-center p-4">
              ...
              <h4 className="card-title fw-bold">ATS Uyumlu</h4>
              <p className="card-text text-muted">
          ...
          <div className="col-md-4">
            <div className="card h-100 border-0 shadow-sm text-center p-4">
              ...
              <h4 className="card-title fw-bold">PDF İndir</h4>
              <p className="card-text text-muted">
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-6">
              <div className="d-flex align-items-start">
                ...
                <div>
                  <h4 className="fw-bold">ATS Nedir ve Neden Önemlidir?</h4>
                  <p className="text-muted">
            ...
            <div className="col-lg-6">
              <div className="d-flex align-items-start">
                ...
                <div>
                  <h4 className="fw-bold">ATS Uyumlu CV Nasıl Olmalı?</h4>
      ...
      <section className="py-5 text-center container">
        ...
        <Link to="/cv-ats" className="btn btn-dark btn-lg px-5 shadow">
          Ücretsiz Başla
        </Link>
      </section>
    </div>
